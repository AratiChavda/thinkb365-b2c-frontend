...
import { DollarSign, Layers, User } from "lucide-react";

const AddOnManagement = ({ setIsAdding, setEditingId }: any) => {
  ...
  const {
    ...
    globalFilter,
    setGlobalFilter,
  } = useTableData({ data: addOns, initialPageSize: 10 });
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-500">
            Power up subscriptions — create and manage flexible addons
          </p>
        </motion.div>
                    ...
                    <CardContent className="p-4 space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm text-gray-700">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="ml-1">{item.max_users}</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <DollarSign className="w-4 h-4 text-muted-foreground" />
                          <span className="font-medium">Price:</span>
                          <span className="ml-1">{item.pricing}</span>
                        </div>
                      </div>
        ...
        >
          <Card className="rounded-xl border-0 shadow-md bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-primary-100/30 via-primary-50/30 to-primary-100/30">
            <CardContent className="p-8 text-center">
              <Icons.addOn className="h-12 w-12 text-gray-300 mx-auto mb-4" />
